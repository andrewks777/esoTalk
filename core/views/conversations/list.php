...
echo URL("conversations/".$data["channelSlug"]."?search=".urlencode($searchWithoutLimit.($searchWithoutLimit ? " + " : "")."#".T("gambit.limit:").($data["limit"] + ETSearchModel::getMoreConversationsCount()))); ?>'><?php echo T("View more"); ?></a>
</li>
<?php endif; ?>
