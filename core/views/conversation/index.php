...
if ($conversation["canModerate"] or ($conversation["startMemberId"] == ET::$session->userId and !$conversation["locked"])): ?><a href='<?php echo URL("conversation/edit/".$conversation["conversationId"]); ?>'><?php echo sanitizeHTML($conversation["title"]); ?></a><?php
