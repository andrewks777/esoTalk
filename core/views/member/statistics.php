...
<a href='<?php echo URL(searchURL("#".T("gambit.author:").encodeTerm($member["username"]))); ?>' class='control-search'><i class='icon-search'></i></a>
</div></li>

<li><label><?php echo T("Conversations participated in"); ?></label> <div>
<?php echo number_format($statistics["conversationsParticipated"]); ?>
<a href='<?php echo URL(searchURL("#".T("gambit.contributor:").encodeTerm($member["username"]))); ?>' class='control-search'><i class='icon-search'></i></a>
</div></li>
