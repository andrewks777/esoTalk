...
<?php if ($plugin["settings"]): ?><a href='<?php echo URL("admin/plugins/settings/$k"); ?>' class='button pluginSettings' data-plugin='<?php echo $k; ?>'><?php echo "<i class='icon-cogs'></i> ".T("Settings"); ?></a> <?php endif; ?>
