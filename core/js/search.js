...
init: function() {
	...
	body.on('click', '#conversations a', function() {
	...
	body.on('click', '#conversations .unreadIndicator', function(e) {
		e.preventDefault();
	...
	body.on('click', '#conversations .channel', function(e) {
