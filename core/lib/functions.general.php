...
function sanitizeHTML2($value)
{
	return htmlentities($value, ENT_QUOTES | ENT_SUBSTITUTE, "UTF-8");
}


// from: http://www.php.net/manual/ru/function.urldecode.php#101401
function ansi_to_utf8($string) {
