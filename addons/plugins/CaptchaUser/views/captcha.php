...
<object type="application/x-shockwave-flash" data="<?php echo $resURL; ?>/securimage_play.swf?bgcol=#ffffff&amp;icon_file=<?php echo $resURL; ?>/images/audio_icon.png&amp;audio_file=<?php echo URL('captcha/play'); ?>" height="32" width="32">
<param name="movie" value="<?php echo $resURL; ?>/securimage_play.swf?bgcol=#ffffff&amp;icon_file=<?php echo $resURL; ?>/images/audio_icon.png&amp;audio_file=<?php echo URL('captcha/play'); ?>" />
</object>
&nbsp;
