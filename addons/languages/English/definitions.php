...
$definitions["fromKB"] = "Exclude from a KB";
...
$definitions["Give this group the 'manage KB' permission on all existing channels"] = "Give this group the 'manage KB' permission on all existing channels";
...
$definitions["label.KB"] = "Knowledge base";
...
$definitions["Manage KB"] = "Knowledge engineer";
...
$definitions["toKB"] = "Include in a KB";
...
$definitions["message.confirmDiscardDraft"] = "Do you wish to discard a saved draft?";
...
$definitions["message.cookieAuthenticationTheft"] = "For security reasons, we couldn't log you in with your 'remember me' cookie. Please log in manually!<br><br>The previous autologin was %s from IP %s. Current IP %s";
...
$definitions["message.imageLoadingError"] = "Image loading error!";
